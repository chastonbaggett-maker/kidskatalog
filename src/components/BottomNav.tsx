...
export function BottomNav() {
  ...
  return (
    <nav className="bottom-nav absolute inset-x-0 bottom-0 z-40 rounded-t-[2rem] border-t border-white/40 bg-white/55 px-2.5 pt-2 shadow-[0_-8px_24px_-12px_rgba(80,100,180,0.28)] backdrop-blur-2xl backdrop-saturate-150">
